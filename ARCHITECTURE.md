...
> PoC: Audio transcription comparison webapp — upload audio, transcribe with 5 engines, compare results with timecoded playback.
...
All 5 services implement a common `TranscriptionService` base class:
...
- Azure OpenAI: Already in seconds — pass through
